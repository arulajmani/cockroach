...
func runMultiTenantUpgrade(ctx context.Context, t test.Test, c cluster.Cluster, v version.Version) {
	...
	const tenantNode = 2
	tenant11 := createTenantNode(
		ctx, t, c, kvNodes, tenant11ID, tenantNode, tenant11HTTPPort, tenant11SQLPort, true, /* secure */
	)
	...
	tenant12 := createTenantNode(
		ctx, t, c, kvNodes, tenant12ID, tenantNode, tenant12HTTPPort, tenant12SQLPort, true, /* secure */
	)
	...
	tenant13 := createTenantNode(
		ctx, t, c, kvNodes, tenant13ID, tenantNode, tenant13HTTPPort, tenant13SQLPort, true, /* secure */
	)
	...
	tenant14 := createTenantNode(
		ctx, t, c, kvNodes, tenant14ID, tenantNode, tenant14HTTPPort, tenant14SQLPort, true, /* secure */
	)
